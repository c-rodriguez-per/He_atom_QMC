...
def test_metropolis(
  ...
  wep_trial = np.linspace(2.3,2.7,N_points)
  wee_trial = np.linspace(1.2,1.6,N_points)
  fep_trial = np.linspace(0.6,1,N_points)
  fee_trial = np.linspace(0.3,0.5,N_points)
  ...
  for wbf in wbf_trial:
    for fbf in fbf_trial:
